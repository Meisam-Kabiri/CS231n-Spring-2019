...
#        X_trained_extended=self.X_train.reshape(1,num_train,self.X_train.shape[1])
#        X_test_extend=X.reshape(num_test,1,X.shape[1])
#        dists=np.sum(np.square(X_trained_extended-X_test_extend),axis=2)
