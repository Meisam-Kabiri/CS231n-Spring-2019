...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        D, H, W = input_dim
        self.params['W1'] = np.random. normal (0, weight_scale, (num_filters, D, filter_size, filter_size))
    ...
    def loss(self, X, y=None):
        ...
        #(dw += self.reg * dw for dw in [grads['W1'], grads['W2'], grads['W3']] ) 
        for dW in (grads['W1'], grads['W2'], grads['W3']):
                dW += self.reg * dW
